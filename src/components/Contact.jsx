    ...
    >
      ...
      <div className="flex gap-[150px] contact-section">
        <div className="flex flex-col gap-[30px] contact-left">
          ...
          <p className="max-w-[550px] text-[#D8D8D8] leading-[25px]">
        ...
        >
          ...
          <textarea
            ...
            className="w-[700px] border-none rounded-sm bg-[#32323c] text-[#a0a0a0] font-outfit text-[20px] contact-textarea"
          ></textarea>

          <button
            type="submit"
            className="contact-btn border-none text-white rounded-4xl bg-[linear-gradient(267deg,_#df8908_-5.09%,_#B415FF_106.28%)] text-[22px] py-[20px] px-[60px] mb-[50px] cursor-pointer transition-all duration-[300ms] hover:transform hover:scale-110"
          >
            Submit Now
          </button>
        </form>
